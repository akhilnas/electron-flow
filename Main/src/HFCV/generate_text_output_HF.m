function generate_text_output_HF(output_dir)
...
files = dir(fullfile(output_dir, 'mat_files','HFCV','*.mat'));
input_file = fullfile(output_dir, 'mat_files','HFCV',files.name);
load(input_file);
...
fid = fopen(fullfile(CV_dir, 'HFCV.txt'),'w');
